...
<head>
    ...
    <link rel="stylesheet" href="maqq.css">
</head>
<body>
    <nav >
        <div  class="divlogo">
    ...
    <div class="divcontenu">
        <section class="section1">
            ...
            <p>
                <img src="/images/boxes-packing-solid.svg" alt="" width="15" height="15">
            ...
            <p>
                <img src="/images/x-circle.svg" alt="" width="15" height="15">
                <a href="">bons de commandes</a>
                
            </p>
        </section>
        <section class="section2">
            <a href="formulaire.php">ajouter les données</a>
            <div class="divsearch">
                <input type="text" placeholder="recherche">
                <img src="/images/plus.png" alt="" width="20" height="20">
            </div>
            <div id="der">
                    ...
                    <table>
                       ...
                       <?php foreach($reponse as $valeur){?>
                            <tr class="bordure">
                                ...
                                <td><img src="/images/justesvg.svg" alt="" width="25" height="25"></td>
                            </tr>
                            <?php }?>
